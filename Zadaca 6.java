...
public class Zadac6 {
    ...
    public static void main(String[] args) {
        // TODO code application logic here
         //int[] values  = {6, 5, 7, 11};
        /*System.out.println("Najmanji je " + smallest(values));
        System.out.println("Najmanji je na indexu " + indexOfSmallest(values));
        System.out.println("Najmanji je na indexu " + indexOfTheSmallestStartingFrom(values, 2));*/
       ...
       /*
        ...
        System.out.println();
        System.out.print("Unesi pretraznje brojeve: ");
